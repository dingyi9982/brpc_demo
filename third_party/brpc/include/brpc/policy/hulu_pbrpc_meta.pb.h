...
inline void HuluRpcRequestMeta::clear_credential_data() {
  credential_data_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
inline void HuluRpcRequestMeta::_internal_set_credential_data(const std::string& value) {
  _has_bits_[0] |= 0x00000008u;
  credential_data_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
...
inline void HuluRpcRequestMeta::set_credential_data(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000008u;
  credential_data_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
...
inline void HuluRpcRequestMeta::set_credential_data(const void* value, size_t size) {
  _has_bits_[0] |= 0x00000008u;
  credential_data_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
...
inline std::string* HuluRpcRequestMeta::_internal_mutable_credential_data() {
  _has_bits_[0] |= 0x00000008u;
  return credential_data_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* HuluRpcRequestMeta::release_credential_data() {
  ...
  _has_bits_[0] &= ~0x00000008u;
  return credential_data_.ReleaseNonDefaultNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void HuluRpcRequestMeta::set_allocated_credential_data(std::string* credential_data) {
  ...
  credential_data_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), credential_data);
