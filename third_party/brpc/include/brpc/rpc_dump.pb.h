...
inline void RpcDumpMeta::clear_nshead() {
  nshead_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
inline void RpcDumpMeta::_internal_set_nshead(const std::string& value) {
  _has_bits_[0] |= 0x00000010u;
  nshead_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
...
inline void RpcDumpMeta::set_nshead(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000010u;
  nshead_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
...
inline void RpcDumpMeta::set_nshead(const void* value, size_t size) {
  _has_bits_[0] |= 0x00000010u;
  nshead_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:brpc.RpcDumpMeta.nshead)
}
inline std::string* RpcDumpMeta::_internal_mutable_nshead() {
  _has_bits_[0] |= 0x00000010u;
  return nshead_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* RpcDumpMeta::release_nshead() {
  ...
  _has_bits_[0] &= ~0x00000010u;
  return nshead_.ReleaseNonDefaultNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void RpcDumpMeta::set_allocated_nshead(std::string* nshead) {
  ...
  nshead_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), nshead);
