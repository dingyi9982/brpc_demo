...
inline void TracingSpan::clear_span_name() {
  span_name_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  _has_bits_[0] &= ~0x00000001u;
}
...
inline void TracingSpan::_internal_set_span_name(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  span_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
...
inline void TracingSpan::set_span_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000001u;
  span_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
...
inline void TracingSpan::set_span_name(const char* value, size_t size) {
  _has_bits_[0] |= 0x00000001u;
  span_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
...
inline std::string* TracingSpan::_internal_mutable_span_name() {
  _has_bits_[0] |= 0x00000001u;
  return span_name_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* TracingSpan::release_span_name() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return span_name_.ReleaseNonDefaultNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void TracingSpan::set_allocated_span_name(std::string* span_name) {
  ...
  span_name_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), span_name);
