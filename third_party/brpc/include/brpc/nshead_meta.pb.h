...
inline void NsheadMeta::clear_full_method_name() {
  full_method_name_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
inline void NsheadMeta::_internal_set_full_method_name(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  full_method_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
...
inline void NsheadMeta::set_full_method_name(const char* value) {
  ...
  _has_bits_[0] |= 0x00000001u;
  full_method_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
...
inline void NsheadMeta::set_full_method_name(const char* value, size_t size) {
  _has_bits_[0] |= 0x00000001u;
  full_method_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
inline std::string* NsheadMeta::_internal_mutable_full_method_name() {
  _has_bits_[0] |= 0x00000001u;
  return full_method_name_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* NsheadMeta::release_full_method_name() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return full_method_name_.ReleaseNonDefaultNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void NsheadMeta::set_allocated_full_method_name(std::string* full_method_name) {
  ...
  full_method_name_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), full_method_name);
...
inline void NsheadMeta::clear_user_string() {
  user_string_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
inline void NsheadMeta::_internal_set_user_string(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  user_string_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
...
inline void NsheadMeta::set_user_string(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000002u;
  user_string_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
...
inline void NsheadMeta::set_user_string(const void* value, size_t size) {
  _has_bits_[0] |= 0x00000002u;
  user_string_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
...
inline std::string* NsheadMeta::_internal_mutable_user_string() {
  _has_bits_[0] |= 0x00000002u;
  return user_string_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* NsheadMeta::release_user_string() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  return user_string_.ReleaseNonDefaultNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void NsheadMeta::set_allocated_user_string(std::string* user_string) {
  ...
  user_string_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), user_string);
